...
public class AndroidHelpScreen extends Screen {
	private Stage m_stage;
	private Window m_window;
	private Sound m_click;
	private Vector2 m_screenSize;
	
	public AndroidHelpScreen(ScreenManager owner, SokobanGame game,  Skin uiSkin, Sound click) {
	...
	private void createWidgets(SokobanGame game,  Skin uiSkin) {
		...
		Label moveLabel = new Label(bundle.get("move_android_help"), uiSkin, "default");
