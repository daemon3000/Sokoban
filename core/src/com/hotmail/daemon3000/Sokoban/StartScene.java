...
public class StartScene implements Scene {
	...
	public void onLoad() {
		...
		if(Gdx.app.getType() == ApplicationType.Desktop) {
			m_screenManager.addScreen(new DesktopHelpScreen(m_screenManager, m_game, m_uiSkin, m_click));
			m_screenManager.addScreen(new DesktopOptionsScreen(m_screenManager, m_game, m_uiSkin, m_click));
		}
		else {
			m_screenManager.addScreen(new AndroidHelpScreen(m_screenManager, m_game, m_uiSkin, m_click));
			m_screenManager.addScreen(new AndroidOptionsScreen(m_screenManager, m_game, m_uiSkin, m_click));
		}
