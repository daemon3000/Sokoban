...
public class DesktopHelpScreen extends Screen {
	private Stage m_stage;
	private Window m_window;
	private Sound m_click;
	private Vector2 m_screenSize;
	
	public DesktopHelpScreen(ScreenManager owner, SokobanGame game,  Skin uiSkin, Sound click) {
	...
	private void createWidgets(SokobanGame game,  Skin uiSkin) {
		...
		m_window.setWidth(450);
		m_window.setHeight(225);
		m_window.setPosition(m_screenSize.x + m_window.getWidth(), m_screenSize.y / 2 - m_window.getHeight() / 2);
		
		Label objectiveLabel = new Label(bundle.get("objective_help"), uiSkin, "default");
		m_window.addActor(objectiveLabel);
		objectiveLabel.setPosition(15.0f, m_window.getHeight() - 80.0f);
		
		Label moveLabel = new Label(bundle.get("move_desktop_help"), uiSkin, "default");
		m_window.addActor(moveLabel);
		moveLabel.setPosition(15.0f, objectiveLabel.getY() - 25.0f);
		
		Label undoLabel = new Label(bundle.get("undo_desktop_help"), uiSkin, "default");
